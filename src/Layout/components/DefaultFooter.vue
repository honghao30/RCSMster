  ...
  <footer class="footer">
    ...
    >
      ...
      <ul class="agency-list">
          <li class="tworld">
            <a href="https://www.sktelecom.com/index.html"  target="_blank">
              <img src="@/assets/images/layout/logo_tworld.svg" alt="SK Tworld">
          </a></li>
          <li class="kt">
            <a href="https://www.kt.com/" target="_blank">
              <img src="@/assets/images/layout/logo_kt.svg" alt="KT">
            </a>
          </li>
          <li class="uplus">
            <a href="https://www.lguplus.com/" target="_blank">
             <img src="@/assets/images/layout/logo_lgu.svg" alt="LG U+">
            </a>
           </li>
      </ul>
