...
export default {
  ...
  data() {
    return {
      ...
      faqData: [
        {
          question: '브랜드 개설이란 무엇인가요?',
          answer: 'RCS는 브랜드를 통해 입력받은 정보(프로필 이미지, 대화방명, 브랜드홈 정보 등) 를 문자 수신고객이 저장하지 않더라도 보여줄 수 있는 특징이 있습니다. 브랜드 개설은 이를 위한 사전 과정으로, 입력 정보에는 백그라운드 이미지와, 프로필 이미지, 브랜드명, 브랜드 설명, 노출시킬 전화번호 등의 정보입력이 필요하며, 해당 브랜드 정보를 노출시킬 발신번호를 입력 후 승인과정을 거치면 완료됩니다.'
        },
        {
          question: '브랜드 개설을 하는데 어느정도 시간이 소요되나요?',
          answer: ''
        },
        {
        ...
        {
          question: '브랜드 개설 요청 시 어떤 경우에 반려가 되나요?',
          answer: ''
        },
        {
          question: '브랜드 개설은 메시징 발송 사업자의 사이트에서 할 수 없나요?',
          answer: ''
        }
      ]
    }
