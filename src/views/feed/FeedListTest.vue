                ...
                <div class="file-preview-content-container">
                    <div class="file-preview-container">
                        <div v-for="(file, index) in files" :key="index" class="file-preview-wrapper">
                            ...
                            <div  @click="fileUpButton" :index="index">
                                UP
                            </div>
                            <div @click="fileDownButton" :index="index">
                                DOWN
                            </div>
                        </div>
                        <!--
...
export default {
  ...
  */
    ...
    fileUpButton(e) {
      ...
      if (index !== 0) {
        let currentList = this.files
        const item = currentList.splice(index, 1) // ['banana']
        currentList.splice(index - 1, 0, item[0]) // [ 'apple', 'cherry', 'banana', 'grape' ]

        this.files = currentList
      }
    },
    fileDownButton(e) {
      const index = e.target.getAttribute('index')
