  ...
  <div>
    <div class="sec_header">
      ...
      <div class="box_search_area mar_b30" v-if="this.searchRadio === 'feed'">
        ...
        <div class="filter_bundle col_5 tit_char4">
      ...
      <div class="box_scroll mar_t20">
        <div class="tbl_sorting_wrap th_multi">
          <el-table :data="statList" style="width: 100%" v-show="searchTypeCheck" empty-text="검색 결과가 없습니다.">
            <el-table-column prop="ymd" label="날짜" width="95"/>
            <el-table-column prop="corpName" label="기업" align="left" width="90"/>
            <el-table-column prop="brandName" label="브랜드명" align="left" width="176"/>
            <el-table-column prop="feedId" label="소식 ID" align="left" width="115"/>
            <el-table-column prop="title" label="소식제목" align="left" width="125"/>
            <el-table-column prop="type" label="유형" width="85"/>
            <el-table-column prop="pageview" label="페이지 뷰">
              <el-table-column prop="pvCnt" label="당일" width="74"/>
              <el-table-column prop="pvTotCnt" label="누적" width="74"/>
            </el-table-column>
            <el-table-column prop="buttonClick" label="버튼 클릭 수">
              <el-table-column prop="buttonClick1" label="버튼1">
                <el-table-column prop="btn1ClCnt" label="당일" width="74"/>
                <el-table-column prop="btn1ClTotCnt" label="누적" width="74"/>
              </el-table-column>
              <el-table-column prop="buttonClick2" label="버튼2">
                <el-table-column prop="btn2ClCnt" label="당일" width="74"/>
                <el-table-column prop="btn2ClTotCnt" label="누적" width="74"/>
              </el-table-column>
            </el-table-column>
            <el-table-column prop="sharingType" label="Sharing type">
              <el-table-column prop="sharingContentClick" label="Share컨텐츠 클릭수">
                <el-table-column prop="slClCnt" label="당일" width="75"/>
                <el-table-column prop="slClTotCnt" label="누적" width="75"/>
              </el-table-column>
            </el-table-column>
          </el-table>
          ...
          <el-table
            ...
            style="width: 100%"
            v-show="!searchTypeCheck"
            empty-text="검색 결과가 없습니다."
          >
            <el-table-column prop="ymd" label="날짜" width="100"/>
            <el-table-column prop="corpName" label="기업" align="left" width="100"/>
            <el-table-column prop="brandName" label="브랜드명" align="left" width="175"/>
            <el-table-column prop="feedId" label="소식 ID" align="left" width="120"/>
            <el-table-column prop="feedTitle" label="소식제목" align="left" width="145"/>
            <el-table-column prop="title" label="Slide 소식 제목" align="left" width="130"/>
            <el-table-column prop="slideType" label="slide 유형" width="150"/>
            <el-table-column prop="buttonClick" label="버튼 클릭 수">
              <el-table-column prop="buttonClick1" label="버튼1">
