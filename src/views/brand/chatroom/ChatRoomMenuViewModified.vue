    ...
    <div class="brand__inner">
      ...
      <div class="brand-info__wrap">
        ...
        <div class="chatroom__wrap chatroom-menu__wrap">  <!-- 기획서 v1.0 수정 (chatroom-menu__wrap 이중클래스 추가) -->
          <div class="chatroom-registration menu-modify-box">
        ...
        <!-- 기획서 v1.0 수정
          [취소]선택 시, 수정 내용 미반영 상태로 대화방 메뉴 목록으로 이동
          [등록]선택 시, 수정 내용 반영된 상태로 대화방 메뉴 목록으로 이동 -->
        <div class="button__wrap space-between">
          <router-link
            to="/ChatRoomMenuList"
            class="btn btn-line"
          >취소</router-link>
          <!-- 기획서 v1.0 수정 (btn컴포넌트 -> router-link 변경 및 링크연결) -->
          <router-link
            to="/ChatRoomMenuList"
            class="btn btn-blue"
            :disabled = "isDisabled"
...
export default {
  ...
  data() {
    return {
      ...
      // 기획서 v1.0 수정 (dropdownOptions 삭제)
      isModalViewed: false,
      // 기획서 v1.0 수정 (isChatRoomChange 삭제)
      isBrandNews: false,
  ...
  methods: {
    ...
    // 기획서 v1.0 수정 ( closeMsg )
    closeMsg () {
      this.isModalViewed = false
      this.isRemoveMenu = false
