        ...
        <div class="top-ctrl-area">
          <div class="left-area">
            <el-date-picker
              ...
              ref="datePicker"
            />
            <div class="radio__btn-type">
              <span class="radio-btn">
                <input type="radio" name="range" id="1w" value="1w" class="blind" v-model="selDateRange" @change="changeRange"/>
                <label for="1w">1주일</label>
              </span>
              <span class="radio-btn">
                <input type="radio" name="range" id="1m" value="1m" class="blind" v-model="selDateRange" @change="changeRange"/>
                <label for="1m">1개월</label>
              </span>
              <span class="radio-btn">
                <input type="radio" name="range" id="3m" value="3m" class="blind" v-model="selDateRange" @change="changeRange"/>
