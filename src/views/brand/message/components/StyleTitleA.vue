     ...
     <tr>
       ...
       <td>
         ...
         <!-- 로고 등록 -->
           ...
           <div class="form-item-row" v-if="info.logoType === 'basic'">
           ...
           <div class="form-item-row" v-if="info.logoType === 'custom'">
...
export default {
  ...
  mounted() {
    this.info.titleType = 'styleTitle'
  },
  methods: {
    // 이미지 파일 업로드
    onFileChanged (e) {
