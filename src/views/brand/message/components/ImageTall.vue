<template>
  <table class="table table-bodyonly form-table">
    ...
    <tbody>
    <tr>
      <th scope="row"><span class="form-item__label required">장형 이미지</span></th>
      <td>
        <div class="form-item__content">
          <div class="form-item-row">
            <div class="input-item">
              <span class="radiobox">
                <input type="radio" name="imageOptions" id="imageOptionsSquare" value="square" v-model="mainImgInfo.imgType"/>
                <label for="imageOptionsSquare"><span class="radiobox__text">정방형 (1:1)</span></label>
              </span>
              <span class="radiobox">
                <input type="radio" name="imageOptions" id="imageOptionsVertical" value="tall" v-model="mainImgInfo.imgType"/>
...
export default {
  ...
  methods: {
    ...
    onFileChanged(e) {
      ...
      const file = files[0]
      console.log('ImageTall -', this.mainImgInfo.imgType, ' file', file)
