...
import Item from '@/views/brand/message/components/Emulator/ItemB.vue'
...
import Thumnails from '@/views/brand/message/components/Emulator/Thumnail.vue'
...
import Banner from '@/views/brand/message/components/Emulator/Banner.vue'
