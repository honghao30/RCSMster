  ...
  <div class="form-item__content">
    <div class="form-item-row">
      <div class="inner__input">
        ...
        <div class="form-item-row" v-if="buttonInfo.btnEventDropdown == 'call'"> <!-- 기획서 v1.0 수정  -- v-if 수정 -->
        ...
        <div class="form-item-row" v-if="buttonInfo.btnEventDropdown == 'urlExternal'"> <!-- 기획서 v1.0 수정  -- v-if 수정 -->
          <div class="input-item input-limit">
            <div class="input">
