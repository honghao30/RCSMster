    ...
    <div class="brand__inner">
      <div class="brand-info__wrap">
                ...
                <tr v-if="form.noticeInfo.includes('reservation')">
                  ...
                  <td>
                    <div class="form-item__content">
                      <div class="form-item-row">
                        <div class="input-item">
                          <span class="input"><input type="text" class="input" placeholder="URL 주소를 입력해주세요."  v-model="form.reservation" ></span>
                        </div>
                      </div>
                ...
                <tr v-if="form.noticeInfo.includes('appdownload')">
                  ...
                  <td>
                    <div class="form-item__content">
                      <div class="form-item-row">
                        <div class="input-item">
                          <span class="input"><input type="text" class="input" placeholder="URL 주소를 입력해주세요. (예:http://www.portal.com)"  v-model="form.app" ></span>
                        </div>
                      </div>
                ...
                <tr v-if="form.noticeInfo.includes('chat')">
                  ...
                  <td>
                    <div class="form-item__content">
                      <div class="form-item-row">
                        <div class="input-item">
                          <span class="input"><input type="text" class="input" placeholder="URL 주소를 입력해주세요. (예:http://www.portal.com)"  v-model="form.chat" ></span>
                        </div>
                      </div>
        ...
        <div class="agree__area">
          <span class="checkbox">
            <input type="checkbox" id="agreeY" v-model="agree"><label for="agreeY">메시지 발송 시 Free 템플릿은 정보성에 한하여 이용 가능합니다. 규정 위반시, 서비스 이용이 제한될 수 있습니다.</label>
          </span>
        </div>
