<template>
  <div class="korea-map"  @mouseleave="mapLayerReset">
    <svg width="280" height="407" viewBox="0 0 2500 3500" ref="svgMap">
      ...
      <path @mouseenter="mapMouseEvent('KR-45')" @mouseleave="mapMousehide('KR-45')" title="전라북도" id="KR-45"  class="land"  :class="ColorType + 'st12'" d="M439,2424.6h76l54.2-50.7v-50.7l55.6-16.9l50.7,67.6l67.6-8.4l25.3,67.6h171.7l47.9-42.2l76,42.2
      ...
      <pathclass="land" @mouseenter="mapMouseEvent('KR-46')" @mouseleave="mapMousehide('KR-46')" title="전라남도" id="KR-46" ref="KR-46" class="land" :class="ColorType + 'st13'"  d="M1064.1,2517.5v-84.5l-76-42.2l-47.9,42.2H768.5l-25.3-67.6l-67.6,8.4l-50.7-67.6l-55.6,16.9v50.7
