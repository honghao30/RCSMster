  ...
  <div class="brand__wrap">
    <div class="brand__inner">
      ...
      <div class="brand-info__wrap">
        <PageTitle pagetitle="간편챗봇 메시지 수정" />
...
import ChatCardButtonReg from '@/views/brand/autoreply/components/ChatButtonReg.vue'
import ChatChipButtonReg from '@/views/brand/autoreply/components/ChatChipButtonReg.vue'
