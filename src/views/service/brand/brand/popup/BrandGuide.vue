      ...
      <div tabindex="0" class="layer_cont brand_create_guide">
        <div class="brand_create_guide_wrap">
          <div class="guide_down" style="text-align: left;">
            <span class="h4_title bold">브랜드 가이드</span>
            <span class="h4_desc bold">- '개설안내 내려받기' 버튼을 클릭하시면 가이드를 내려받을 수 있습니다.</span>
            <a href="javascript:void(0)" class="btn sml black" @click="downloadGuide">개설안내 내려받기</a>
          </div>
          <div class="guide_scr" style="height: 600px;">
            <vue-pdf-app pdf="/BrandCreateGuide.pdf" :config="config" :pageNumber="1" pageScale="page-width" theme="light" @open="openHandler" @pages-rendered="loadComplete"></vue-pdf-app>
          </div>
