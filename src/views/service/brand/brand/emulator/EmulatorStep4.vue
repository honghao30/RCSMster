<template>
  <div class="rcs_emulator_wrap open_brand type2" style="margin-top:0;">
    <div class="rcs_inner_emul">
      ...
      <div class="rcs_emulator_area">
        ...
        <div class="rcs_emul_cont">
          ...
          <div class="mar_t10">
            <img src="@/assets/images/common/emul_tab_img_news.png"  v-if="feedInfoData.curTab === 'FEED'">
            <img src="@/assets/images/common/emul_tab_img.png"  v-else-if="feedInfoData.curTab === 'INFO'">
          </div>
          <div class="rcs_detail_area" v-if="feedInfoData.curTab === 'FEED'">
            <ul>
              <li class="BrandNews_emul dv2023_feed-select">
                <!-- <p class="BrandNews_emul_title">{{ brandInfoData.name || '브랜드명' }}의 이야기가 준비중입니다.</p>
                <p class="imgwrap_news_website" v-if="feedInfoData.initFeedItem === 'HOME'"><img src="@/assets/images/common/emul_news_website.png" alt=""></p>
                <p class="imgwrap_news_call" v-else-if="feedInfoData.initFeedItem === 'TEL'"><img src="@/assets/images/common/emul_news_call.png" alt=""></p>
                <p class="imgwrap_news_search" v-else-if="feedInfoData.initFeedItem === 'SEARCH'"><img src="@/assets/images/common/emul_news_search.png" alt=""></p>
                <span class="emul_brand_line"></span>
                <p class="BrandNews_emul_weblink" v-if="feedInfoData.initFeedItem === 'HOME'">웹사이트 바로가기</p>
                <p class="BrandNews_emul_weblink" v-else-if="feedInfoData.initFeedItem === 'TEL'">전화걸기</p>
                <p class="BrandNews_emul_weblink" v-else-if="feedInfoData.initFeedItem === 'SEARCH'">포탈검색 바로가기</p> -->
                <div v-if="feedInfoData.initFeedItem === 'HOME'">
                  <div><img src="@/assets/images/icons/emul-feed-site.svg"/></div>
                  <p>브랜드 웹 사이트 보기</p>
                </div>
                <div v-else-if="feedInfoData.initFeedItem === 'TEL'">
                  <div><img src="@/assets/images/icons/emul-feed-call.svg"/></div>
                  <p>전화하기</p>
                </div>
                <div v-else-if="feedInfoData.initFeedItem === 'SEARCH'">
                  <div><img src="@/assets/images/icons/emul-feed-search.svg"/></div>
                  <p>브랜드 검색하기</p>
                </div>
              </li>
            </ul>
          </div>
          <div class="rcs_detail_area" v-else-if="feedInfoData.curTab === 'INFO'">
            <ul>
              <li class="tell_icon">
...
export default {
  ...
  watch: {
    'brandInfoData.descr'() {
      this.brandInfoData.descr = this.brandInfoData.descr.replace(/on.*\(|eval\(|javascript/gi, '').split('\n').join('<br />')
    },
    ...
    'brandInfoData.bgImgFileId'() {
      if (!jglib.isEmpty(this.brandInfoData.bgImgFileId) && !jglib.isEmpty(this.brandInfoData.bgImgFileNo)) {
...
.dv2023_feed-select > div > div {
  width: 80px;
  height: 80px;
  display: grid;
  place-content: center;
}
.dv2023_feed-select > div > div > img {
  width: 90%;
}
.dv2023_feed-select > div > p {
  font-size: 16px;
  color: #333333;
  padding-right: 16px;
  background-image: url("../../../../../assets/images/icons/icon-chevron-right-black2.svg");
