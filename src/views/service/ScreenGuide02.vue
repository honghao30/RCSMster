    ...
    <div class="guide__inner">
      ...
      <div class="user-guide__wrap screenguide__wrap">
        ...
        <div class="guide-page__title">
          <h3>기업 대시보드</h3>
          <p class="description">기업 대시보드에서 내 기업에 소속된 브랜드를 확인하고 관리할 수 있습니다.</p>
        </div>
        <div class="guide__item">
          ...
          <div class="guide-img__wrap">
            <img src="@/assets/images/guide/guide_ScreenGuide02_01.png" alt="" class="only-pc">
            <img src="@/assets/images/guide/guide_ScreenGuide02_01_mo.png" alt="" class="only-mo">
          </div>
        </div>
        <div class="guide__item">
          <div class="subtitle-wrap">
          ...
          <div class="guide-img__wrap">
            <img src="@/assets/images/guide/guide_ScreenGuide02_02.png" alt="" class="only-pc">
            <img src="@/assets/images/guide/guide_ScreenGuide02_02_mo.png" alt="" class="only-mo">
          </div>
        </div>
      </div>
    </div>
