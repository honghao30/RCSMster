    ...
    <div v-if="isLoading && !isFirst || totalCount > 0" tabindex="0" class="layer active">
        <div tabindex="0" class="layer_cont">
          <div class="layer_head">
            <p class="mar_b20">
              자동응답을 사용할 양방향 대화방을 선택하세요.<br>
              선택된 대화방으로 바로 이동 하실 수 있습니다.
            </p>
          ...
          <div v-if="totalCount > 0" class="layer_body">
          ...
          <div class="layer_foot">
            ...
            <div class="btn_wrap mar_t30">
              ...
              <a href="javascript:void(0);" @click="goTwoWayDetail" class="btn sml black">
                <span>확인</span>
              </a>
            </div>
      ...
      <div tabindex="0" class="layer_cont">
        ...
        <div class="layer_foot">
          <div class="btn_wrap mar_t30">
            ...
            <a href="javascript:void(0);" @click="goTwoWayRegistration" class="btn sml black">
              <span>확인</span>
            </a>
          </div>
        </div>
