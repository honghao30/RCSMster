    ...
    <div class="guide__inner">
      ...
      <div class="user-guide__wrap screenguide__wrap">
        ...
        <div class="guide-page__title">
          <h3>대화방</h3>
          <p class="description">기업 담당자와 대행사는 대화방이 등록되어야 고객들에게 RCS메시지를 전송할 수 있습니다.</p>
        </div>
        <div class="guide__item">
          ...
          <div class="guide-img__wrap">
            <img src="@/assets/images/guide/guide_ScreenGuide05_01.png" alt="" class="only-pc">
            <img src="@/assets/images/guide/guide_ScreenGuide05_01_mo.png" alt="" class="only-mo">
          </div>
        </div>
      </div>
    </div>
