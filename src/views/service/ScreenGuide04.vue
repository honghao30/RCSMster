    ...
    <div class="guide__inner">
      ...
      <div class="user-guide__wrap screenguide__wrap">
        ...
        <div class="guide-page__title">
          <h3>브랜드 대시보드</h3>
          <p class="description">기업의 담당자와 대행사가 각 브랜드별 상태를 한눈에 파악하여 효율적으로 RBC의 기능을 활용할 수 있습니다.</p>
        </div>
        <div class="guide__item">
          <div class="subtitle-wrap">
            <h4>1. 기업 담당자, 대행사 브랜드 대시보드</h4>
          </div>
          <div class="guide-img__wrap">
            <img src="@/assets/images/guide/guide_ScreenGuide04_01.png" alt="" class="only-pc">
            <img src="@/assets/images/guide/guide_ScreenGuide04_01_mo.png" alt="" class="only-mo">
          </div>
        </div>
      </div>
    </div>
